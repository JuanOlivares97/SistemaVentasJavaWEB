                ...
                <div class="card">
                    <form action="controlador?menu=NuevaVenta" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="form-group d-flex">
                                    <div class="col-sm-4 d-flex">
                                        ...
                                        &nbsp;
                                        <button class="btn btn-outline-info" value="BuscarProducto" name="accion" type="submit">Agregar</button>
                                        &nbsp;
                                    </div>
                                    <div class="col-sm-8">
                            ...
                            <br>
                            <div class="form-group">
                                <button class="btn btn-outline-info" value="Agregar" name="accion" type="submit">Agregar Producto</button>
                            </div>
                            <br>
                        </div>
                </div>
